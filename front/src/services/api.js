...
const searchData = [
  ...
  // Новости
  {
    id: 8,
    type: 'news',
    title: 'Новые программы MBA в 2024 году',
    description: 'NARKOZ Business School запускает новые специализированные программы MBA',
    url: '/news/1',
    category: 'Новости',
    tags: ['MBA', 'новые программы', '2024']
  },
  {
    id: 9,
    type: 'news',
    title: 'Партнерство с международными университетами',
    description: 'Подписаны соглашения о сотрудничестве с ведущими бизнес-школами мира',
    url: '/news/2',
    category: 'Новости',
    tags: ['партнерство', 'международное сотрудничество']
  },
  {
    id: 10,
    type: 'news',
    title: 'Выпускники NBS в топ-100 компаний',
    description: 'Наши выпускники занимают руководящие позиции в крупнейших компаниях',
    url: '/news/3',
    category: 'Новости',
    tags: ['выпускники', 'карьера', 'успех']
  },
