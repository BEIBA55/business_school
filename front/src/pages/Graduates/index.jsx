  ...
  const events = [
    {
      ...
      description:
        'Традиционная встреча выпускников всех лет для обмена опытом и установления новых связей',
    },
    {
  ...
  const news = [
    {
      ...
      date: '10 ноября 2024',
      excerpt:
        'Алексей Петров, выпускник программы MBA 2020 года, назначен генеральным директором...',
    },
    {
      title: 'Успешный запуск стартапа выпускницей Executive MBA',
      date: '5 ноября 2024',
      excerpt:
        'Мария Иванова, выпускница Executive MBA 2022 года, успешно запустила технологический стартап...',
    },
    {
      title: 'Международная конференция выпускников в Астане',
      date: '1 ноября 2024',
      excerpt:
        'В столице Казахстана прошла первая международная конференция выпускников Narxoz Business School...',
    },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 animate-fade-in">Выпускникам</h1>
          <p
            className="text-lg md:text-xl mb-6 max-w-3xl mx-auto animate-fade-in"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Narxoz Business School — это не просто школа, это сообщество лидеров, объединяющее
                  более 3500 выпускников в Казахстане. Наши выпускники строят мосты между
                  культурами, ведут бизнес без границ и вносят вклад в устойчивое и инклюзивное
                  будущее.
                </p>
                <p>
                  Сеть выпускников обеспечивает поддержку и возможности на каждом этапе вашего пути.
                  Ежегодно мы собираемся на встречи, участвуем в программах непрерывного обучения,
                  сессиях менторства и совместных инициативах, чтобы делиться опытом и расти вместе.
                </p>
                <p>
              ...
              <div className="mt-8">
                <p className="text-xl font-bold text-[#991E1E]">
                  Присоединяйтесь к Narxoz Business School и станьте частью сообщества, которое
                  вдохновляет, поддерживает и двигается вперёд вместе с вами.
                </p>
              </div>
            </div>
