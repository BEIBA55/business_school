...
const Faculty = () => {
  ...
  const specializations = ['all', 'Финансы и инвестиции', 'Развитие бизнеса', 'Маркетинг и аналитика', 'Медиация и корпоративное управление', 'Корпоративное право', 'Финансовая отчетность', 'Лидерство и коучинг', 'HR-менеджмент'];
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center px-8">
          ...
          <div className="mb-12 max-w-4xl mx-auto px-4">
            <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed text-white/90 font-light">
              Преподаватели <span className="font-semibold text-white">Нархоз Business School</span> — это практикующие специалисты 
              с опытом работы в ведущих международных компаниях и научными степенями от лучших бизнес-школ мира
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Выберите область для просмотра преподавателей
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Факультет Нархоз Business School в цифрах
            </p>
          </div>
