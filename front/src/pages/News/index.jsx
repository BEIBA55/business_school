  ...
  const allNews = [
    {
      ...
      fullContent: 'Реальные руководители из реальных компаний на практике внедрявшие инструменты контрактного менеджмента. Наши эксперты имеют многолетний опыт работы в ведущих корпорациях и готовы поделиться своими знаниями со студентами Narxoz Business School.'
    },
    {
      id: 2,
      ...
      fullContent: 'Программа MBA Бизнес-школы Университета Нархоз заняла 42-е место в рейтинге QS Global MBA 2025 Asia и стала №1 в Центрально-Азиатском регионе. Это историческое достижение для казахстанского образования и признание высокого качества наших программ.'
    },
    {
      id: 3,
      ...
      fullContent: 'Narxoz Business School представила обновленную программу Executive MBA, которая включает модули по искусственному интеллекту и цифровым технологиям. Программа разработана в сотрудничестве с ведущими технологическими компаниями и включает практические проекты.'
    },
    {
      id: 4,
      ...
      fullContent: 'Команда Narxoz Business School заняла второе место на международном хакатоне по устойчивому развитию, организованном партнерскими университетами. Наши студенты представили инновационное решение для экологических проблем в регионе.'
    },
    {
      id: 5,
      ...
      fullContent: 'В кампусе Нархоз открылся современный корпоративный центр с инновационными аудиториями и пространствами для командной работы. Центр оснащен последними технологиями и создает идеальную среду для обучения руководителей.'
    },
    {
      id: 6,
      ...
      fullContent: 'Бизнес-школа Нархоз стала первой в Центральной Азии, получившей престижную аккредитацию AACSB International. Это подтверждает соответствие наших программ мировым стандартам качества образования.'
    },
    {
      id: 7,
      ...
      fullContent: 'Подписаны соглашения о сотрудничестве с Harvard Business School и London Business School для обмена студентами и преподавателями. Это открывает новые возможности для наших студентов и преподавателей.'
    },
    {
      id: 8,
      ...
      fullContent: 'Новая специализация MBA фокусируется на экологических, социальных и управленческих аспектах современного бизнеса. Программа готовит лидеров, способных создавать устойчивый бизнес будущего.'
    },
    {
      id: 9,
      ...
      fullContent: 'Команда MBA студентов победила в престижном конкурсе, организованном European Foundation for Management Development. Наши студенты показали высокий уровень аналитических и презентационных навыков.'
    },
    {
      id: 10,
      ...
      fullContent: 'Новый центр предоставляет студентам возможности для развития стартапов и инновационных проектов. Центр оснащен современным оборудованием и предоставляет менторскую поддержку.'
    },
    {
      id: 11,
      ...
      fullContent: 'Университет Нархоз улучшил свои позиции в рейтинге Times Higher Education Emerging Economies University Rankings. Это подтверждает высокое качество образования и исследований.'
    },
    {
      id: 12,
      ...
      fullContent: 'Подписаны меморандумы о сотрудничестве с ERG, Kazzinc и другими ведущими компаниями для стажировок студентов. Это обеспечивает практическую подготовку наших выпускников.'
    },
    {
      id: 13,
      ...
      fullContent: 'Новая программа MBA специализации включает современные инструменты цифрового маркетинга и аналитики данных. Программа разработана в сотрудничестве с ведущими digital-агентствами.'
    },
    {
      id: 14,
      ...
      fullContent: 'Совместная программа подготовки специалистов в области финансов и банковского дела. Программа включает стажировки в банке и практические проекты.'
    },
    {
      id: 15,
      ...
      fullContent: 'Narxoz Business School провела крупнейшую в регионе конференцию с участием экспертов из 25 стран. Конференция стала платформой для обмена опытом и установления новых партнерств.'
    },
    {
      id: 16,
      ...
      fullContent: 'Запущена специальная программа для развития лидерских качеств у женщин в бизнесе. Программа включает менторство, коучинг и сетевые мероприятия.'
    }
  ];
