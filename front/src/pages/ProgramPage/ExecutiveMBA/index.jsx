    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="text-7xl lg:text-8xl font-bold mb-8 leading-tight">EXECUTIVE MBA</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="flex justify-center">
              <div className="relative">
                <img src="/images/Krug.png" alt="Executive MBA студенты" className="w-96 h-96" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                <p>
                  Программа Executive MBA в Нархоз Business School разработана специально для
                  руководителей высшего звена, собственников бизнеса и предпринимателей с опытом
                  управления от 7 лет. Это программа для тех, кто уже достиг определенных высот в
                  карьере и стремится к новому уровню.
                </p>
                <p>
                  Программа аккредитована Foundation for International Business Administration
                  Accreditation (FIBAA) и предоставляет уникальную возможность получить международно
                  признанную степень MBA, не прерывая карьеру.
                </p>
              </div>
            </div>
          </div>
              ...
              <div key={f.number} className="flex items-center bg-white rounded-2xl shadow p-8">
                <div className="flex-1">
                  <div className="flex items-center gap-6 mb-1">
                    ...
                    <div className="text-sm font-semibold text-[#991E1E] bg-[#FDEAEA] rounded px-3 py-1">
                      {f.stats}
                    </div>
                  </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="flex gap-3">
              <span className="bg-[#991E1E] text-white px-6 py-2 rounded-xl font-semibold">
                18 месяцев
              </span>
              <span className="bg-[#991E1E] text-white px-6 py-2 rounded-xl font-semibold">
                12 модулей
            ...
            {modules.map((m, idx) => (
              <details key={m.title} className="bg-gray-50 rounded-2xl p-6 shadow group">
                <summary className="flex items-center cursor-pointer select-none">
                  ...
                  <span className="ml-4 text-2xl text-gray-400 group-open:rotate-45 transition-transform">
                    +
                  </span>
                </summary>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      Руководящая должность или собственный бизнес
                    </div>
                  </div>
                </div>
                <div className="flex items-start">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-red-900 text-white rounded-2xl p-8 lg:p-12 shadow-2xl">
            ...
            <div className="text-center">
              <p className="text-gray-200 mb-6">Следующий набор стартует в марте 2025 года</p>
              <Button
                onClick={() =>
      ...
      <div id="application-form" className="py-20 px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Подать заявку на обучение</h2>
            <p className="text-xl text-gray-600">
