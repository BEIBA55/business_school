...
const programs = [
  {
    ...
    description: 'Специализированные программы для компаний, адаптированные под их потребности и корпоративную культуру',
  ...
  },
  {
    ...
    description: 'Программы для индивидуальных участников по различным направлениям бизнеса и менеджмента',
...
const features = [
  {
    ...
    description: 'Программы разработаны в соответствии с лучшими мировыми практиками и стандартами AACSB, EQUIS, AMBA',
  ...
  },
  {
    ...
    description: 'Преподаватели с опытом работы в ведущих компаниях мира: McKinsey, PwC, Deloitte, Google, Microsoft',
  ...
  },
  {
    ...
    description: 'Фокус на реальных бизнес-кейсах, проектах и практических навыках, применимых сразу после обучения',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#991E1E] via-[#B91C1C] to-[#DC2626] text-white py-32 px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="mb-8">
            <svg className="w-20 h-20 mx-auto mb-6 text-white/80" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
            </svg>
          </div>
          ...
          <p className="text-2xl lg:text-3xl mb-6 font-medium">
            Развитие лидерских компетенций
          </p>
          <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto leading-relaxed">
            Программы для руководителей и специалистов, стремящихся к профессиональному росту и развитию бизнеса в условиях цифровой трансформации
          </p>
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="text-5xl font-bold text-[#991E1E] mb-2">
                  {animatedNumbers[index]}{stat.number === 95 ? '%' : '+'}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center mb-6">
                ...
                <span className="text-[#991E1E] font-semibold uppercase tracking-wide">О программе</span>
              </div>
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                ...
                <p>
                  За 25 лет работы мы обучили более 5000 руководителей и специалистов, 
                  многие из которых сегодня возглавляют ведущие компании Казахстана и региона.
                </p>
              </div>
              <div className="mt-8 flex flex-wrap gap-4">
                <div className="flex items-center text-sm text-gray-600">
                  <svg className="w-5 h-5 text-[#991E1E] mr-2" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative">
                <div className="w-96 h-96 bg-gradient-to-br from-[#991E1E] to-[#B91C1C] rounded-3xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="text-white text-center relative z-10">
                    <svg className="w-24 h-24 mx-auto mb-6 text-white/90" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                    </svg>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center mb-6">
              <div className="w-12 h-1 bg-[#991E1E] mr-4"></div>
              <span className="text-[#991E1E] font-semibold uppercase tracking-wide">Программы</span>
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-sm text-gray-500">
                    <svg className="w-4 h-4 mr-2 text-[#991E1E]" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                    </svg>
      ...
      <div className="py-24 px-8" style={{ backgroundColor: '#F9FAFB' }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center mb-6">
              <div className="w-12 h-1 bg-[#991E1E] mr-4"></div>
              <span className="text-[#991E1E] font-semibold uppercase tracking-wide">Преимущества</span>
              <div className="w-12 h-1 bg-[#991E1E] ml-4"></div>
            </div>
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Почему выбирают нас
