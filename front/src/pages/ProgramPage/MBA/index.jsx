    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="text-7xl lg:text-8xl font-bold mb-8 leading-tight">ПРОГРАММА MBA</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="flex justify-center">
              <div className="relative">
                <img src="/images/Krug.png" alt="MBA студенты" className="w-96 h-96" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                ...
                <p>
                  ...
                  стремящихся к развитию лидерских качеств, профессиональному нетворкингу и созданию
                  среды для совместного решения современных вызовов бизнеса.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="py-24 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-16">
            <h2 className="text-4xl font-bold text-gray-900">Видео-отзывы наших студентов</h2>
                ...
                <div className="relative mb-6">
                  <div className="w-full h-56 bg-gray-300 rounded-xl flex items-center justify-center overflow-hidden">
                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg">
                      <svg
                        className="w-6 h-6 text-gray-600 ml-1"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
      ...
      <div className="py-24 px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-12">Особенности программы</h2>
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-3 text-gray-700 text-base leading-relaxed">
                    <li className="flex items-start">
                      ...
                      <span>
                        Каждый месяц на три дня вы погружаетесь в одну тему. Такой формат позволяет
                        концентрировано погрузиться в предмет
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-3 mt-1">•</span>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-start gap-6">
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-bold text-red-800 mb-4">Peer to Peer education</h3>
                  <ul className="space-y-3 text-gray-700 text-base leading-relaxed">
                    <li className="flex items-start">
                      <span className="text-red-600 mr-3 mt-1">•</span>
                      <span>
                        Обучение от равного к равному. Главная ценность EMBA, что вы сможете учиться
                        у других и помогать своим опытом тоже
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-600 mr-3 mt-1">•</span>
                      <span>
                        В вашей группе будут представители разных отраслей и сфер, что расширит ваш
                        опыт группы в несколько раз
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-start gap-6">
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-bold text-red-800 mb-4">Practical Immersion</h3>
                  <ul className="space-y-3 text-gray-700 text-base leading-relaxed">
                    <li className="flex items-start">
                      <span className="text-red-600 mr-3 mt-1">•</span>
                      <span>
                        Обучение проходит на реальных кейсах, задания и проекты связаны с вашей
                        работой
                      </span>
                    </li>
                    <li className="flex items-start">
      ...
      <div className="py-24 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="relative h-[600px] rounded-3xl overflow-hidden shadow-2xl">
            {/* Background Image */}
            <img src="/images/Gradu.png" alt="Выпускники" className="w-full h-full object-cover" />

            {/* Overlay Block */}
            <div className="absolute top-12 right-12 w-96 bg-red-800 text-white p-12 rounded-3xl shadow-2xl">
              <h2 className="text-3xl font-bold mb-8 leading-tight">ФОРМАТ ОБУЧЕНИЯ - МОДУЛЬНЫЙ</h2>
              <div className="space-y-6 text-lg leading-relaxed">
                <p>Мы заметили, что модульный формат снизил выгорание у наших слушателей.</p>
                <p>
                  Интенсивное обучение по выходным раз в месяц хорошо сказывается на
                  результативности и удовлетворенности от своей работы и жизни.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-red-800 mb-4">Обучение без отрыва от работы</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 leading-relaxed">
                Международные и казахстанские преподаватели-практики с профессиональным опытом и
                исследованиями в своих областях
              </p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gray-200 rounded-full mb-6"></div>
              <h3 className="text-xl font-bold text-red-800 mb-4">Нетворкинг</h3>
              <p className="text-gray-700 leading-relaxed">
                Среда для знакомства, обмена опытом, межличностного и делового взаимодействия с
                представителями разных отраслей бизнеса
              </p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gray-200 rounded-full mb-6"></div>
              <h3 className="text-xl font-bold text-red-800 mb-4">Мировой опыт</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gray-200 rounded-full mb-6"></div>
              <h3 className="text-xl font-bold text-red-800 mb-4">Практико-применимые знания</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gray-200 rounded-full mb-6"></div>
              <h3 className="text-xl font-bold text-red-800 mb-4">Прикладные исследования</h3>
              <p className="text-gray-700 leading-relaxed">
                Возможность сотрудничать с исследовательскими центрами Университета Нархоз: SRCC,
                SKRI, GERC, ECELR
              </p>
            </div>
          </div>
      ...
      <div className="py-24 px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-12">Детали программы</h2>

          <div className="relative h-[300px] rounded-3xl overflow-hidden shadow-2xl">
            {/* Background Image */}
            <img src="/images/detali.png" alt="Выпускники" className="w-full h-full object-cover" />
      ...
      <div className="py-24 px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Требования для поступления</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Программа MBA предназначена для специалистов и менеджеров, стремящихся к развитию
              лидерских качеств
            </p>
          </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      Желание развивать управленческие навыки и карьеру
                    </div>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      Русский язык свободно, английский на базовом уровне
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      Интервью с приемной комиссией (очно или онлайн)
                    </div>
                  </div>
                </div>
                <div className="flex">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-red-900 text-white rounded-2xl p-8 lg:p-12 shadow-2xl">
            ...
            <div className="text-center">
              <p className="text-gray-200 mb-6">Следующий набор стартует в сентябре 2025 года</p>
              <Button
                onClick={() =>
      ...
      <div className="py-24 px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-12">Что важно знать</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative h-48 rounded-3xl overflow-hidden shadow-lg">
              ...
              />
              <div
                className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-red-800"
                style={{
                  background:
                    'linear-gradient(to right, transparent 0%, transparent 40%, rgba(153, 30, 30, 0.8) 60%, rgb(153, 30, 30) 100%)',
                }}
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="slide-in-up" style={{ animationDelay: '0.1s' }}>
              ...
              <p className="text-gray-300">+ 7 776 708 3636</p>
            </div>
            ...
            <div className="slide-in-up" style={{ animationDelay: '0.2s' }}>
              ...
              <p className="text-gray-300">gsb@narxoz.kz</p>
            </div>
          </div>
        </div>
      </div>
